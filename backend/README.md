...
## Project Structure
    ...
    ├── testapiautoconnect_120874  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_120874`
...
2. Clone this repo and `cd testapiautoconnect_120874`
